...
// ── Version ────────────────────────────────────────────────────────────────
var PLUGIN_VERSION = 'v5.6.0';  // CẦN BRIDGE ≥1.15.0. Autocut: trang Auto cho bộ 3 video (nhập số bộ + voice + ratio + 3 ô TSV một lần) → validate toàn bộ → gen voice (thông báo macOS) → dựng 3 timeline (dừng nghe thử); tự suy ra tên sequence/bin/voice theo config project; job lỗi không chặn 2 job còn lại. Bridge POST /notify, /autoset/names, /autoset/voicedir.
