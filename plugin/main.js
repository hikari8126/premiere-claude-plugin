...
// ── Version ────────────────────────────────────────────────────────────────
var PLUGIN_VERSION = 'v5.2.4.1';  // (test · bridge server 1.11.6.1) Music v2 mặc định + audio reference (Style/Extend): chọn file reference, mức bám style low/med/high, range 0–30s; bỏ v1; tên mặc định "AI BGM".
